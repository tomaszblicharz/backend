...
@ActiveProfiles("test")
class MedicalSpecializationControllerTest {
    @Autowired
    ...
    @Test
    @Transactional
    void shouldRet8urn400WhenNameIsBlankPostSaveMedSpec() throws Exception {
        ...
        newMedSpec.setName("");
        newMedSpec.setDoctor(doctorRepository.save(newDoctor));

        mockMvc.perform(MockMvcRequestBuilders.post("/medspecialization").contentType(MediaType.APPLICATION_JSON)
